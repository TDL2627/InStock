...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://your-default-url.supabase.co'
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'your-default-anon-key'
